...
class DocumentController extends SecureController{
	...
	function index($fieldname = null , $fieldvalue = null){
		...
		if(!empty($request->search)){
			...
			$search_condition = "(
				...
				document.Kode_Klasifikasi LIKE ? OR 
	...
	function add($formdata = null){
		if($formdata){
			...
			$request = $this->request;
			//fillable fields
			$fields = $this->fields = array("Nama_Berkas","Tahun","Kode_Klasifikasi","Ruangan","Rak","Dus","Lokasi","File");
	...
	function edit($rec_id = null, $formdata = null){
		...
		$tablename = $this->tablename;
		 //editable fields
		$fields = $this->fields = array("id_document","Nama_Berkas","Tahun","Kode_Klasifikasi","Ruangan","Rak","Dus","Lokasi","File");
		if($formdata){
			$postdata = $this->format_request_data($formdata);
			$this->rules_array = array(
				'Nama_Berkas' => 'required',
