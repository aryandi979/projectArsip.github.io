                            ...
                            <div>
                                <div class="form-group ">
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="form-group ">
                                            <div id="ctrl-Kode_Klasifikasi-holder" class="">
                                                <input id="ctrl-Kode_Klasifikasi"  value="<?php  echo $this->set_field_value('Kode_Klasifikasi',""); ?>" type="text" placeholder="Enter Kode Klasifikasi"  required="" name="Kode_Klasifikasi"  class="form-control " />
                                                </div>
                                            </div>
                                            <div class="row">
                                                    ...
                                                    <div class="form-group col-md-3">
                                                        ...
                                                        <div class="form-group ">
                                                            <div id="ctrl-Lokasi-holder" class="">
                                                                <input id="ctrl-Lokasi"  value="<?php  echo $this->set_field_value('Lokasi',""); ?>" type="text" placeholder="Lokasi"  name="Lokasi"  class="form-control " />
                                                                </div>
                                                            </div>
                                                            <div class="form-group ">
