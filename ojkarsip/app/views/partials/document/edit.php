                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="form-group ">
                                            <div class="row">
                                                <div class="col-sm-4">
                                                    <label class="control-label" for="Kode_Klasifikasi">Kode Klasifikasi <span class="text-danger">*</span></label>
                                                </div>
                                                <div class="col-sm-8">
                                                    <div class="">
                                                        <input id="ctrl-Kode_Klasifikasi"  value="<?php  echo $data['Kode_Klasifikasi']; ?>" type="text" placeholder="Enter Kode Klasifikasi"  required="" name="Kode_Klasifikasi"  class="form-control " />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="form-group col-md-3">
                                                        ...
                                                        <div class="form-group ">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    <div class="">
                                                                        <input id="ctrl-Lokasi"  value="<?php  echo $data['Lokasi']; ?>" type="text" placeholder="Lokasi"  name="Lokasi"  class="form-control " />
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
