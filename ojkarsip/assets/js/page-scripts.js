...
$(document).ready(function() {
	...
	$('#ctrl-Ruangan').on('keyup', function(){ 
let Ruangan = $(this).val();
let Rak = $('#ctrl-Rak').val();
let Dus = $('#ctrl-Dus').val();
	if(Ruangan !=='' || Rak !== '' || Dus !== ''){
		let Lokasi = Ruangan + '.' + Rak + '.' + Dus;
	$('#ctrl-Lokasi').val(Lokasi);
}
});
$('#ctrl-Rak').on('keyup', function(){ 
let Rak = $(this).val();
let Ruangan = $('#ctrl-ruangan').val();
let Dus = $('#ctrl-Dus').val();
	if(Ruangan !=='' || Rak !== '' || Dus !== ''){
		let Lokasi = Ruangan + '.' + Rak + '.' + Dus;
	$('#ctrl-Lokasi').val(Lokasi);
